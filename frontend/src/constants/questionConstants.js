...
export const QUESTION_TOP_REQUEST = "QUESTION_TOP_REQUEST";
export const QUESTION_TOP_SUCCESS = "QUESTION_TOP_SUCCESS";
export const QUESTION_TOP_FAIL = "QUESTION_TOP_FAIL";
